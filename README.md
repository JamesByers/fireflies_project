...
This Byers Built project delivers both hardware and firmware for turning an addressable LED string into simulated fireflies
...
*  [Sample code](./code/Firefly_and_rainbow_rpzero_dimmer_brd_2_0_1
/Firefly_and_rainbow_rpzero_dimmer_brd_2_2_x.ino). Written in Arduino C++
...
* Reads the rotary knob to determine which one of the eight color affects to apply
   ...
   6.  85% Green, 15% Blue
   7.  85% Green, 15% Red
   8.  Displays the hue selected using what normally is the dimmer knob
